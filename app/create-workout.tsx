...
export default function CreateWorkoutScreen() {
  ...
  useEffect(() => {
    if (isEditing && currentWorkout) {
      ...
      setWarmUpDuration(
        currentWorkout.warmUpDuration?.toString() || ''
      );
      setCoolDownDuration(
  ...
  const validate = useCallback((): boolean => {
    ...
    return true;
  }, [name, workDuration, restDuration, rounds, warmUpDuration, coolDownDuration]);
  ...
  return (
    ...
    >
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.label}>Warm-up Duration (seconds, optional)</Text>
        <TextInput
          style={styles.input}
        ...
        <Text style={styles.label}>Cool-down Duration (seconds, optional)</Text>
        <TextInput
          style={styles.input}
